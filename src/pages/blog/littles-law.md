...
What's the diff? Running [Open Messaging Benchmark][omb] with this change allowed us to easily push 10x more data and hit the GB/s scale without needing to change any producer configurations. If you're interested in learning more about Cloud Topics, check out [this blog][ct-blog] I wrote on the overall architecture.
